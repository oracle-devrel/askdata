...
#              TRUST METRICS               #
############################################
def size_trust_library(start_date=None, end_date=None):
    """
...
def size_trust_library_source(start_date=None, end_date=None):
    """
...
def percentage_prompts_trust_level(start_date=None, end_date=None):
    """
...
def accuracy_untrusted(start_date=None, end_date=None):
    """
...
def accuracy_semitrusted(start_date=None, end_date=None):
    """
...
#               USER METRICS               #
############################################
def users_number(start_date=None, end_date=None):
    """
...
def users_number_prompts(start_date=None, end_date=None):
    """
...
def users_number_prompts_trust_level(start_date=None, end_date=None):
    """
...
if __name__ == "__main__":
    ...
    confb.read_configuration(suffix=os.getenv("NL2SQL_ENV"))
