...
@router.post("/process_users_autocertify")
async def process_users_autocertify(domain=None):
    """
    ...
    ```
    """
    logger.info("Calling process users autocertify")
    ret= ctrl.process_users_autocertify(domain=domain)
